...
public class LineChartImple extends DbMonitorFragment {
    ...
    public LineChartImple(ViewGroup rootview){
    ...
    {
        lineChart = rootview.findViewById(R.id.graph_two_graph);
